...
let MyNoSQLDB = {
  ...
  users: [
    ...
    { id: 5, name: 'Mau', age: 22 },
    { id: 6, name: 'KAt', age: 22 },
    { id: 7, name: 'test', age: 22 },
    { id: 8, name: 'data', age: 22 },
    { id: 9, name: 'pizza', age: 22 },
    { id: 10, name: 'this is a test', age: 22 },
    { id: 11, name: 'idk', age: 22 },
    { id: 12, name: 'hee!', age: 22 },
    { id: 13, name: 'hi everyone', age: 22 },
    { id: 14, name: 'job', age: 22 },
    { id: 15, name: 'karl', age: 22 },
    // ... more user documents
  ],
